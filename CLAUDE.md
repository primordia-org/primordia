...
| Evolve draft persistence | ✅ Live | Initial request drafts in `/evolve` and the floating Propose-a-change dialog share a local timestamped draft; follow-up drafts are saved per thread until submitted; drafts older than one year are garbage-collected |
