...
Also hardened the evolve preview panel against simple self-recursion: if the iframe resolves to the same pathname as the session page itself, the panel shows a short “Preview hidden to prevent infinitely nested previews” message with a “Show Anyway” override.
