...
export const metadata = {
  title: "Core API Test",
  description: "Exercise the Primordia Core HTTP and SSE protocol with a web API key.",
};
      ...
      <header className="border-b border-gray-800 bg-gray-900 px-6 py-4">
        <div className="mx-auto flex max-w-4xl items-center justify-between gap-4">
          <div>
            ...
            <p className="mt-0.5 text-xs text-gray-500">Test Primordia Core POST and SSE calls with a revokable web API key.</p>
          </div>
