// app/admin/proxy-settings/page.tsx — Proxy settings admin panel.
// Lets admins configure proxy magic numbers (inactivity timeout, disk threshold, etc.).
// Admin-only.
...
import AdminProxySettingsClient from "@/components/AdminProxySettingsClient";

export function generateMetadata(): Metadata {
  return {
    title: buildPageTitle("Proxy Settings"),
    description: "Configure proxy timeouts and thresholds.",
  };
}

export default async function AdminProxySettingsPage() {
  ...
  if (!adminCheck) {
    return (
      <ForbiddenPage
        pageDescription="This page lets you configure proxy timeouts and automatic cleanup thresholds."
  ...
  return (
    <main className="flex flex-col w-full max-w-3xl mx-auto px-4 py-6 min-h-dvh">
      ...
      <AdminSubNav currentTab="proxy-settings" />
      <AdminProxySettingsClient />
    </main>
  );
}
