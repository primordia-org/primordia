...
const BOX_FEATURES = [
  ...
  },
  {
    ...
    description:
      "API keys and credentials are stored encrypted in SQLite. Credentials are decrypted right before use and deleted immediately after.",
  },
  {
...
function HowItWorksStep({
  ...
  return (
    <div className="relative">
      ...
      {!isLast && (
        <div className="hidden sm:block absolute top-5 left-16 -right-4 h-px bg-gradient-to-r from-white/10 via-white/10 to-transparent -translate-y-px" aria-hidden="true" />
      )}
