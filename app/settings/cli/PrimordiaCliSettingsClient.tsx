    ...
    <section className="rounded-2xl border border-gray-800 bg-gray-900/60 p-5 shadow-xl shadow-black/20">
      <div className="mb-5">
        ...
        <p className="mt-2 text-sm leading-6 text-gray-400">
          Create revokable keys for operations that require secrets like <code className="rounded bg-black/30 px-1.5 py-0.5 text-gray-200">bun run primordia thread create</code>, <code className="rounded bg-black/30 px-1.5 py-0.5 text-gray-200">thread followup</code>, and <code className="rounded bg-black/30 px-1.5 py-0.5 text-gray-200">thread accept</code>. The CLI reads <code className="rounded bg-black/30 px-1.5 py-0.5 text-gray-200">PRIMORDIA_CLI_KEY</code>; revoke a key here to make it unusable.
        </p>
      </div>
