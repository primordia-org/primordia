...
function CreatedApiKeyDetails({ client, secret }: { client: ApiKeyClient; secret: string }) {
  ...
  return (
    <div className="mt-4 rounded-xl border border-emerald-900/70 bg-emerald-950/20 p-4">
