// app/api/thread/manage/route.ts
// Accept or reject a thread — API wrapper around lib/threads.

import { getSessionUser } from '@/lib/auth';
import { manageThread } from '@/lib/threads';

/** JSON body for POST /thread/manage */
export interface ThreadManageBody {
